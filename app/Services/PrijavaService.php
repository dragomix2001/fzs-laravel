...
class PrijavaService
{
     ...
     *
     * @return array{kandidat: Kandidat, profesor: Collection, predmeti: Collection}
     */
     ...
     *
     * @return array{kandidat: Kandidat, profesor: Collection, predmeti: Collection, diplomskiRadTema: DiplomskiPrijavaTeme|null}
     */
    ...
    {
        $prijavaTeme = DiplomskiPrijavaTeme::find($temaId);
        $prijavaTeme->fill($data);
        $prijavaTeme->indikatorOdobreno = $indikatorOdobreno ? 1 : 0;
        $prijavaTeme->save();
     ...
     * Returns null for diplomskiRadTema if no tema exists.
     *
     * @return array{kandidat: Kandidat, profesor: Collection, predmeti: Collection, diplomskiRadTema: DiplomskiPrijavaTeme|null}
     */
     ...
     *
     * @return array{kandidat: Kandidat, profesor: Collection, predmeti: Collection, diplomskiRadTema: DiplomskiPrijavaTeme|null, diplomskiRadOdbrana: DiplomskiPrijavaOdbrane|null}
     */
    ...
    {
        $prijavaOdbrane = DiplomskiPrijavaOdbrane::find($odbranaId);
        $prijavaOdbrane->fill($data);
        $prijavaOdbrane->indikatorOdobreno = $indikatorOdobreno ? 1 : 0;
        $prijavaOdbrane->save();
     ...
     *
     * @return array{kandidat: Kandidat, profesor: Collection, predmeti: Collection, diplomskiRadTema: DiplomskiPrijavaTeme|null, ispitniRok: Collection}
     */
     ...
     *
     * @return array{kandidat: Kandidat, profesor: Collection, predmeti: Collection, diplomskiRadTema: DiplomskiPrijavaTeme|null, diplomskiRadPolaganje: DiplomskiPolaganje|null, ispitniRok: Collection}
     */
    ...
    {
        $prijavaPolaganje = DiplomskiPolaganje::find($polaganjeId);
