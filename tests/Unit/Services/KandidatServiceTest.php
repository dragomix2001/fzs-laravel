...
class KandidatServiceTest extends TestCase
{
    ...
    #[Test]
    public function test_handle_image_upload_saves_image(): void
    {
        TipStudija::factory()->create();
        StatusStudiranja::factory()->create();
        StudijskiProgram::factory()->create();
        ...
        $this->service->handleImageUpload($kandidat, $file);

        $kandidat->refresh();
        $this->assertStringContainsString('slika'.$kandidat->id, $kandidat->slika);
        Storage::disk('uploads')->assertExists('images/'.$kandidat->slika);
    }

    #[Test]
    public function test_handle_image_upload_rejects_non_image(): void
    {
        TipStudija::factory()->create();
        StatusStudiranja::factory()->create();
        StudijskiProgram::factory()->create();
        ...
        $kandidat->refresh();
        $this->assertNull($kandidat->slika);
    }

    #[Test]
    public function test_handle_new_image_upload_saves_image(): void
    {
        TipStudija::factory()->create();
        StatusStudiranja::factory()->create();
        StudijskiProgram::factory()->create();
    ...
    #[Test]
    public function test_handle_pdf_upload_saves_pdf(): void
    {
        TipStudija::factory()->create();
        StatusStudiranja::factory()->create();
        StudijskiProgram::factory()->create();
        ...
        $this->service->handlePdfUpload($kandidat, $file);

        $kandidat->refresh();
        $this->assertStringContainsString('diplomski'.$kandidat->id, $kandidat->diplomski);
    }

    #[Test]
    public function test_handle_pdf_upload_rejects_non_pdf(): void
    {
        TipStudija::factory()->create();
        StatusStudiranja::factory()->create();
        StudijskiProgram::factory()->create();
        ...
        $kandidat->refresh();
        $this->assertNull($kandidat->diplomski);
    }

    #[Test]
    public function test_delete_kandidat_image_removes_file(): void
    {
        TipStudija::factory()->create();
        StatusStudiranja::factory()->create();
        StudijskiProgram::factory()->create();
        ...
        // Now delete it
        $this->service->deleteKandidatImage($kandidat);

        Storage::disk('uploads')->assertMissing('images/'.$kandidat->slika);
    }

    #[Test]
    public function test_delete_kandidat_image_handles_missing_file(): void
    {
        TipStudija::factory()->create();
        StatusStudiranja::factory()->create();
        StudijskiProgram::factory()->create();
