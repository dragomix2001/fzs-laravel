...
class FileStorageServiceTest extends TestCase
{
     ...
     */
    #[Test]
    public function test_upload_image_for_kandidat_saves_image_with_correct_filename(): void
    {
     ...
     */
    #[Test]
    public function test_upload_image_for_kandidat_handles_png_extension(): void
    {
        $kandidat = Kandidat::factory()->create();
     ...
     */
    #[Test]
    public function test_upload_image_for_kandidat_rejects_non_image_file(): void
    {
        $kandidat = Kandidat::factory()->create();
     ...
     */
    #[Test]
    public function test_upload_image_for_kandidat_rejects_text_file(): void
    {
        $kandidat = Kandidat::factory()->create();
     ...
     */
    #[Test]
    public function test_replace_image_for_kandidat_deletes_old_image(): void
    {
        $kandidat = Kandidat::factory()->create();
     ...
     */
    #[Test]
    public function test_replace_image_for_kandidat_uses_correct_filename_format(): void
    {
        $kandidat = Kandidat::factory()->create();
        $file = UploadedFile::fake()->image('photo.jpg');
     ...
     */
    #[Test]
    public function test_replace_image_for_kandidat_deletes_all_old_images(): void
    {
        $kandidat = Kandidat::factory()->create();
     ...
     */
    #[Test]
    public function test_replace_image_for_kandidat_rejects_non_image_file(): void
    {
        $kandidat = Kandidat::factory()->create();
     ...
     */
    #[Test]
    public function test_upload_image_for_kandidat_returns_filename(): void
    {
        $kandidat = Kandidat::factory()->create();
        $file = UploadedFile::fake()->image('photo.jpg');
     ...
     */
    #[Test]
    public function test_replace_pdf_for_kandidat_uses_correct_filename_format_with_dot(): void
    {
        $kandidat = Kandidat::factory()->create();
     ...
     */
    #[Test]
    public function test_replace_pdf_for_kandidat_stores_in_pdf_directory(): void
    {
        $kandidat = Kandidat::factory()->create();
        $file = UploadedFile::fake()->create('diploma.pdf', 100, 'application/pdf');
     ...
     */
    #[Test]
    public function test_replace_pdf_for_kandidat_replaces_file(): void
    {
        $kandidat = Kandidat::factory()->create();
     ...
     */
    #[Test]
    public function test_replace_pdf_for_kandidat_deletes_all_old_pdfs(): void
    {
        $kandidat = Kandidat::factory()->create();
     ...
     */
    #[Test]
    public function test_replace_pdf_for_kandidat_rejects_image_file(): void
    {
        $kandidat = Kandidat::factory()->create();
        $file = UploadedFile::fake()->image('photo.jpg');
     ...
     */
    #[Test]
    public function test_replace_pdf_for_kandidat_rejects_text_file(): void
    {
        $kandidat = Kandidat::factory()->create();
     ...
     */
    #[Test]
    public function test_replace_pdf_for_kandidat_returns_filename(): void
    {
        $kandidat = Kandidat::factory()->create();
        $file = UploadedFile::fake()->create('diploma.pdf', 100, 'application/pdf');
     ...
     */
    #[Test]
    public function test_delete_image_for_kandidat_removes_file(): void
    {
        $kandidat = Kandidat::factory()->create();
     ...
     */
    #[Test]
    public function test_delete_image_for_kandidat_returns_false_when_file_missing(): void
    {
     ...
     */
    #[Test]
    public function test_delete_image_for_kandidat_returns_false_for_empty_slika(): void
    {
     ...
     */
    #[Test]
    public function test_delete_image_for_kandidat_handles_nonexistent_file_in_storage(): void
    {
     ...
     */
    #[Test]
    public function test_delete_image_for_kandidat_returns_true_on_success(): void
    {
        $kandidat = Kandidat::factory()->create();
     ...
     */
    #[Test]
    public function test_upload_image_for_kandidat_handles_gif_extension(): void
    {
        $kandidat = Kandidat::factory()->create();
     ...
     */
    #[Test]
    public function test_replace_image_for_kandidat_updates_kandidat_record(): void
    {
     ...
     */
    #[Test]
    public function test_replace_pdf_for_kandidat_updates_kandidat_record(): void
    {
     ...
     */
    #[Test]
    public function test_upload_image_for_kandidat_updates_kandidat_record(): void
    {
        $kandidat = Kandidat::factory()->create(['slika' => null]);
     ...
     */
    #[Test]
    public function test_upload_image_for_kandidat_filename_has_extension(): void
    {
        $kandidat = Kandidat::factory()->create();
        $file = UploadedFile::fake()->image('photo.jpg');
     ...
     */
    #[Test]
    public function test_replace_pdf_for_kandidat_filename_has_extension(): void
    {
        $kandidat = Kandidat::factory()->create();
        $file = UploadedFile::fake()->create('diploma.pdf', 100, 'application/pdf');
