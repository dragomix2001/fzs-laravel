                ...
                <x-card class="border-success-200">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="form-group">
                            ...
                            <input name="program" type="text" value="{{$program->naziv}}" class="form-input" disabled="disabled">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input name="ocenaOpis" value="{{$diplomski->ocenaOpis}}" type="text" class="form-input">
                        </div>
                        <div class="form-group">
                            <label for="ocenaBroj" class="block text-sm font-medium text-secondary-700 mb-1">Оцена бројчано:</label>
                            <input name="ocenaBroj" value="{{$diplomski->ocenaBroj}}" type="text" class="form-input">
                        </div>
                        <div class="form-group">
                            <label for="naziv" class="block text-sm font-medium text-secondary-700 mb-1">Тема:</label>
                            <input name="naziv" value="{{$diplomski->naziv}}" type="text" class="form-input">
                        </div>
                        <div class="form-group">
                            ...
                            <select class="form-input auto-combobox" id="mentor_id" name="mentor_id">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-input auto-combobox" id="clan_id" name="clan_id">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-input auto-combobox" id="predsednik_id" name="predsednik_id">
                        ...
                        <div class="form-group">
                            ...
                            <input name="datumPrijave" id="datumPrijave" value="{{ date('d.m.Y.',strtotime($diplomski->datumPrijave)) }}" type="text" class="form-input dateMask">
                        </div>
                        <div class="form-group">
                            <label for="datumOdbrane" class="block text-sm font-medium text-secondary-700 mb-1">Датум одбране:</label>
                            <input name="datumOdbrane" id="datumOdbrane" value="{{ date('d.m.Y.',strtotime($diplomski->datumOdbrane)) }}" type="text" class="form-input dateMask">
                        </div>
                    </div>
                ...
                <form role="form" method="post" action="{{ url('/izvestaji/diplomskiAdd/') }}">
                    ...
                    <x-card class="border-success-200">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="form-group">
                                <label for="ocenaOpis" class="block text-sm font-medium text-secondary-700 mb-1">Оцена описно:</label>
                                <input name="ocenaOpis" type="text" class="form-input">
                            </div>
                            <div class="form-group">
                                <label for="ocenaBroj" class="block text-sm font-medium text-secondary-700 mb-1">Оцена бројчано:</label>
                                <input name="ocenaBroj" type="text" class="form-input">
                            </div>
                            <div class="form-group">
                                <label for="naziv" class="block text-sm font-medium text-secondary-700 mb-1">Тема:</label>
                                <input name="naziv" type="text" class="form-input">
                            </div>
                            <div class="form-group">
                                <label for="mentor_id" class="block text-sm font-medium text-secondary-700 mb-1">Ментор:</label>
                                <select class="form-input auto-combobox" id="mentor_id" name="mentor_id">
                            ...
                            <div class="form-group">
                                <label for="datumPrijave" class="block text-sm font-medium text-secondary-700 mb-1">Датум пријаве:</label>
                                <input id="datumPrijave" name="datumPrijave" type="text" class="form-input dateMask">
                            </div>
                            <div class="form-group">
                                <label for="datumOdbrane" class="block text-sm font-medium text-secondary-700 mb-1">Датум одбране:</label>
