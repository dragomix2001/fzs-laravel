...
@section('section')
    ...
    <div class="mb-4">
        <form class="inline-block" method="GET" action="{{"/"}}tipStudija/add">
                ...
                <tr>
                    ...
                    <td>
                        <div class="inline-flex gap-2">
                            <form class="inline-block" action="tipStudija/{{$tipStudija->id}}/edit">
                                <x-button variant="primary" size="sm">Измени</x-button>
                            </form>
                            <form class="inline-block" onsubmit="return confirm('Да ли сте сигурни да желите да обришете податке?');" action="tipStudija/{{$tipStudija->id}}/delete">
