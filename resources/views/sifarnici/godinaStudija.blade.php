...
@section('section')
    ...
    <div class="mb-6">
        <form class="inline-block" method="GET" action="{{"/"}}godinaStudija/add">
                ...
                <tr>
                    ...
                    <td>
                        <div class="inline-flex gap-2">
                            <form class="inline-block" action="godinaStudija/{{$godinaStudija->id}}/edit">
                                <x-button variant="primary" size="sm" type="submit">Измени</x-button>
                            </form>
                            <form class="inline-block" onsubmit="return confirm('Да ли сте сигурни да желите да обришете податке?');" action="godinaStudija/{{$godinaStudija->id}}/delete">
