    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <img class="pull-left" src="{{ asset('images/logo_fzs.png') }}" height="30px" style="margin: 10px 0px 10px 10px">
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li class="{{ Request::is('*kandidat*') ? 'active' : '' }}">
                            <a href="#"><span class="fas fa-user"></span>&nbsp;Кандидати<span class="fas fa-angle-down float-end"></span></a>
                        ...
                        <li class="{{ Request::is('*master*') ? 'active' : '' }}">
                            <a href="#"><span class="fas fa-book"></span>&nbsp;Мастер кандидати<span class="fas fa-angle-down float-end"></span></a>
                            <ul class="nav nav-second-level">
                        ...
                        <li class="{{ Request::is('*student*') ? 'active' : '' }}">
                            <a href="#"><span class="fas fa-graduation-cap"></span>&nbsp;Активни студенти<span class="fas fa-angle-down float-end"></span></a>
                            <ul class="nav nav-second-level">
                        ...
                        <li class="{{ Request::is('*kalendar*') || Request::is('*predmeti*') || Request::is('*zapisnik*') ? 'active' : '' }}">
                            <a href="#"><span class="fas fa-calendar"></span>&nbsp;Испити<span class="fas fa-angle-down float-end"></span></a>
                            <ul class="nav nav-second-level">
                        ...
                        <li class="{{ Request::is('*tipStudija*') || Request::is('*studijskiProgram*') ? 'active' : '' }}">
                            <a href="#"><span class="fas fa-cog"></span>&nbsp;Админ шифарници<span class="fas fa-angle-down float-end"></span></a>
                            <ul class="nav nav-second-level">
                                ...
                                <li {{ (Request::is('*statusKandidata*') ? 'class="active"' : '') }}>
                                    <a href="{{ url('statusKandidata') }}">Статус годудине</a>
                                </li>
                        ...
                        <li class="{{ Request::is('*sport*') || Request::is('*predmet*') || Request::is('*profesor*') ? 'active' : '' }}">
                            <a href="#"><span class="fas fa-table"></span>&nbsp;Шифарници<span class="fas fa-angle-down float-end"></span></a>
                            <ul class="nav nav-second-level">
                        ...
                        <li class="{{ Request::is('*prisustvo*') || Request::is('*aktivnost*') || Request::is('*raspored*') || Request::is('*obavestenja*') || Request::is('*dashboard*') ? 'active' : '' }}">
                            <a href="#"><span class="fas fa-plus-circle"></span>&nbsp;Нови модули<span class="fas fa-angle-down float-end"></span></a>
                            <ul class="nav nav-second-level">
