...
@section('section')
    <div class="w-full lg:w-10/12">
        ...
        <x-card variant="info">
            <x-slot:header>
                <h3 class="text-lg font-semibold">Измена одбране дипломског рада</h3>
            </x-slot:header>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div class="lg:col-span-2">
                        <x-form-select name="predmet_id" label="Дипломски рад из предмета"
                                       ...
                                       :selected="$diplomskiRadOdbrana->predmet_id" />
                    </div>
                    <div class="lg:col-span-2">
                ...
                <div class="space-y-4">
                    <div class="lg:w-8/12">
                        <x-form-select name="temu_odobrio_profesor_id" label="Тему одобрио:"
                                       ...
                                       :selected="$diplomskiRadOdbrana->temu_odobrio_profesor_id" />
                    </div>
                </div>
                ...
                <div class="space-y-4">
                    <div class="flex items-start gap-3">
                        <input type="checkbox" name="indikatorOdobreno" value="1" id="indikatorOdobreno"
                               ...
                               {{ $diplomskiRadOdbrana->indikatorOdobreno == 1 ? 'checked' : '' }}>
                        <label for="indikatorOdobreno" class="font-semibold text-secondary-700">Одбрана одобрена</label>
                    </div>
                    <div class="lg:w-8/12">
                        <x-form-select name="odbranu_odobrio_profesor_id" label="Одбрану одобрио:"
                                       :options="$profesor->mapWithKeys(fn($t) => [$t->id => $t->zvanje . ' ' . $t->ime . ' ' . $t->prezime])->toArray()"
                                       :selected="$diplomskiRadOdbrana->odbranu_odobrio_profesor_id" />
                    </div>
                </div>
