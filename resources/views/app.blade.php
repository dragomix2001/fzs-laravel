		...
		<div class="max-w-7xl mx-auto px-4">
			<div class="flex items-center justify-between h-14">
				<div class="flex items-center gap-4">
					<button type="button" class="inline-flex items-center justify-center p-2 rounded-md text-secondary-500 hover:bg-secondary-100 lg:hidden" data-bs-toggle="collapse" data-bs-target="#navbarNav">
				...
				<div class="hidden lg:flex lg:items-center lg:gap-4" id="navbarNav">
