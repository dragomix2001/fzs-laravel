...
class AuditLogFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            ...
            'created_at' => now('UTC')->subDays(rand(0, 30))->startOfDay()->addHours(rand(10, 16))->addMinutes(rand(0, 59)),
            'updated_at' => now('UTC')->subDays(rand(0, 30))->startOfDay()->addHours(rand(10, 16))->addMinutes(rand(0, 59)),
        ];
    }
